...
`base`元素位于`head`元素之中，通过`href`属性设定文档基准 URL、通过`target`属性设定文档中所有超级链接的默认打开方式。
如：
...
上例中`base`元素`href`的值必须为绝对地址。p 元素中的超级链接最终实际地址为：
...
1. <https://www.w3.org/TR/2017/REC-html52-20171214/document-metadata.html#document-metadata>
