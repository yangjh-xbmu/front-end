...
```{r absolute-positon, echo=FALSE, out.width='95%', fig.show='hold', fig.cap='不同定位方式的区别', fig.align='center'}
...
```{r zindex, echo=FALSE, out.width='95%', fig.show='hold', fig.cap='不同定位方式的区别', fig.align='center'}
